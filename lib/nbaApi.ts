...
export async function formatearPartidoNBA(g: any) {
  ...
  return {
    ...
    homeBadge:  (g.home_team?.abbreviation && g.home_team.abbreviation !== 'UNK') ? `https://a.espncdn.com/i/teamlogos/nba/500/${g.home_team.abbreviation.toLowerCase()}.png` : '',
    ...
    awayBadge:  (g.visitor_team?.abbreviation && g.visitor_team.abbreviation !== 'UNK') ? `https://a.espncdn.com/i/teamlogos/nba/500/${g.visitor_team.abbreviation.toLowerCase()}.png` : '',
